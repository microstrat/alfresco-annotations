 ...
 * </ul>
 * A proper configurer will create webscript name according to Alfresco requirements (<code>webscript.[name].[http-method]</code>)
 *
...
public @interface WebScript {
    ...
    /**
     * WebScript name with (or without) path name. I.e. <code>myWebScript</code> or <code>it.cnj.myWebScript</code>
     *
     * @return a bean name
     */
    String value();
